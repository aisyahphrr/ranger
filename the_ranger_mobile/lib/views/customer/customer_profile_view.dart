...
class CustomerProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final name = appState.customerName ?? 'Customer';
    final phone = appState.customerPhone.isEmpty
        ? 'Nomor belum diatur'
        : appState.customerPhone;
        ...
        body: ListView(
          ...
          children: [
            _ProfileHeader(
              ...
              wishlistCount:
                  appState.products.where((item) => item.liked).length,
              rating: rating,
              onEditPhoto: () => _showInfo(
                context,
                'Foto Profil',
                'Penggantian foto profil siap dihubungkan ke layanan penyimpanan akun.',
              ),
            ),
              ...
              items: [
                _ProfileMenuData(
                  ...
                  onTap: () => _showInfo(
                    context,
                    'Voucher & Promo',
                    appState.promotions.isEmpty
                        ? 'Belum ada voucher atau promo yang tersedia.'
                        : 'Promo tersedia di halaman Beranda.',
                  ),
                ),
                _ProfileMenuData(
                  label: 'Bantuan & FAQ',
                  ...
                  onTap: () => _showInfo(
                    context,
                    'Bantuan & FAQ',
                    'Pusat bantuan akan menampilkan FAQ dan kanal Customer Care setelah service bantuan terhubung.',
                  ),
                ),
                _ProfileMenuData(
                  ...
                  onTap: () => _showInfo(
                    context,
                    'Privasi & Keamanan',
                    'Data profil dan riwayat customer disimpan pada storage akun aplikasi.',
                  ),
                ),
                _ProfileMenuData(
                  label: 'Pengaturan',
                  ...
                  onTap: () => _showInfo(
                    context,
                    'Pengaturan',
                    'Pengaturan aplikasi akan tersedia setelah preferensi customer terhubung.',
                  ),
                ),
              ],
            ),
  ...
  Future<void> _showEditProfile(
    ...
    final nameController =
        TextEditingController(text: appState.customerName ?? '');
    final addressController =
        TextEditingController(text: appState.customerAddress ?? '');
    final locationController =
        TextEditingController(text: appState.customerLocation ?? '');
          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Lokasi singkat'),
              ),
            ],
          ),
        ),
  ...
  Future<void> _confirmLogout(
    ...
    final shouldLogout = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text('Sesi customer akan dihapus dari perangkat ini.'),
        actions: [
          TextButton(
    ...
    if (shouldLogout == true) await appState.logoutCustomer();
  }
