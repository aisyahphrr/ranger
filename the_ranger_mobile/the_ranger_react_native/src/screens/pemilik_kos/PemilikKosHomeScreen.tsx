...
interface KosHomeProps extends Nav {
  authAccount?: AuthAccount | null;
}

export const PemilikKosHomeScreen: React.FC<KosHomeProps> = ({ navigate, authAccount }) => {
  const propertyName = authAccount?.roleData.businessName || "Nama kos belum diatur";
  const propertyAddress = authAccount?.roleData.businessAddress || authAccount?.address || "Alamat properti belum diatur";
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.topHeader}>
        <View style={styles.storeInfo}>
          ...
          <View>
            <Text style={styles.storeName}>{propertyName}</Text>
