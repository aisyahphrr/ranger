...
export default function App() {
  ...
  const [customerName, setCustomerName] = useState("Asep Kurniawan");
  const [customerPhone, setCustomerPhone] = useState("0821-4567-8901");
  const [customerAddress, setCustomerAddress] = useState("Perumahan Kamojang Indah Blok C No. 42, Garut");
  const [customerLocation, setCustomerLocation] = useState("Ring 1 Kamojang");

  const [addresses, setAddresses] = useState<CustomerAddress[]>([
    {
      id: "addr_1",
      label: "Rumah",
      receiverName: "Asep Kurniawan",
      phoneNumber: "0821-4567-8901",
      fullAddress: "Perumahan Kamojang Indah Blok C No. 42, Garut, Jawa Barat",
      notes: "Samping Masjid Al-Hidayah, pagar hijau",
      isMain: true,
    },
    {
      id: "addr_2",
      label: "Kantor PGE",
      receiverName: "Asep Kurniawan (PGE)",
      phoneNumber: "0821-4567-8901",
      fullAddress: "Kantor Pertamina Geothermal Energy Area Kamojang, Kec. Ibun, Bandung, Jawa Barat",
      notes: "Titip pos satpam depan",
      isMain: false,
    },
  ]);
